  ...
  apps: [
    {
      ...
      env: {
        ...
        PAYFAST_BANK_CODE_EASYPAISA: process.env.PAYFAST_BANK_CODE_EASYPAISA || '',
        PAYFAST_BANK_CODE_JAZZCASH: process.env.PAYFAST_BANK_CODE_JAZZCASH || '',
        PAYFAST_WALLET_ACCOUNT_TYPE_ID: process.env.PAYFAST_WALLET_ACCOUNT_TYPE_ID || '',
        SUBSCRIPTION_TRIAL_DAYS: process.env.SUBSCRIPTION_TRIAL_DAYS || '',
        PREMIUM_PLAN_DURATION_MONTHS: process.env.PREMIUM_PLAN_DURATION_MONTHS || '',
        PAYMENT_MOCK_ENABLE: process.env.PAYMENT_MOCK_ENABLE || '',
        PAYFAST_CHECKOUT_DISABLED: process.env.PAYFAST_CHECKOUT_DISABLED || '',
        SUBSCRIPTION_PREMIUM_SURFACE_BYPASS: process.env.SUBSCRIPTION_PREMIUM_SURFACE_BYPASS || '',
        MANUAL_SUBSCRIPTION_WHATSAPP: process.env.MANUAL_SUBSCRIPTION_WHATSAPP || '',
      },
    },
    {
      name: 'frontend',
