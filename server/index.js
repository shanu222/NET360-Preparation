  ...
  for (let generationAttempt = 1; generationAttempt <= AI_SINGLE_MCQ_MAX_REGENERATIONS; generationAttempt += 1) {
    ...
    const runCompletion = async () => {
      ...
      const generationCommand = [
        ...
        '',
        'Your task is to STRICTLY replicate the pattern of the uploaded MCQs.',
        '',
        '========================',
        'SOURCE MCQs (MANDATORY)',
        '========================',
        '',
        ...
        '========================',
        '',
        '- You MUST copy the SAME structure, wording style, and logic',
        '- Questions should look like they came from the SAME paper',
        '- ONLY change numbers, names, or small elements',
        '- DO NOT invent new types of questions',
        '- DO NOT change format or style',
        '- DO NOT add theory-based questions',
        '',
        'Think of this as:',
        '"Paraphrase + regenerate with same pattern"',
        '',
        '========================',
        'TASK',
        '========================',
        '',
        `Generate ${safeRequestedCount} MCQs that are:`,
        '',
        '- Structurally IDENTICAL to source MCQs',
        '- Same difficulty level',
        '- Same logic pattern',
        '- Same style of options',
        '',
        '========================',
        'FORMAT (EXACT COPY STYLE)',
        '========================',
        '',
        'MCQ 1',
        '',
        ...
        '========================',
        '',
        'If your generated MCQs do NOT closely resemble the source MCQs,',
        'REWRITE them before output.',
      ].join('\n');
